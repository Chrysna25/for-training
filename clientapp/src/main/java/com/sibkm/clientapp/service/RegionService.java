...
public class RegionService {
  ...
  public Region getById(Integer id){
    ...
    return restTemplate.exchange(url.concat("/" + id), HttpMethod.GET, null, Region.class)
      .getBody(); 
  }

  public Region create(Region region){
    return restTemplate.exchange(url, HttpMethod.POST, new HttpEntity<Region>(region),
  ...
  public Region update(Integer id, Region region){
    ...
    return restTemplate.exchange(url.concat("/" + id), HttpMethod.PUT, request,  Region.class)
      .getBody(); 
  }
